...
This is a very well crafted piece of code. The challenge of the attack is to get the address of the stting "/bin/sh" in the =rdi= register. But we have no clue
