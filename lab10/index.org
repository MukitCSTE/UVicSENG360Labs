...
Use Wireshark to capture 3 minute of your internet traffic (try 3 minutes first, if the generated file is small enough try running it for longer). The lab instructor will show you how to run it. During these 15 minutes do the following:
